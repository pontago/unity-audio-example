...
class AudioManager {
  ...
  var latestDbfs: Float32 = 0.0
  var latestDbspl: Float32 = 0.0
  ...
  private let renderCallback: AURenderCallback = {
    ...
    AudioManager.shared.latestDbfs = leftdB
    AudioManager.shared.latestDbspl = convertedDB
...
@_cdecl("setupAudioSession")
public func setupAudioSession() {
  AudioManager.shared.setupAudioSession()
}

@_cdecl("latestInputAudioDbfs")
public func latestInputAudioDbfs() -> Float {
  AudioManager.shared.latestDbfs
}

@_cdecl("latestInputAudioDbspl")
public func latestInputAudioDbspl() -> Float {
  AudioManager.shared.latestDbspl
}
